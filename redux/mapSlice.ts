  ...
  reducers: {
    setActive: (state, action) => {
      state.active.state = action.payload.state
        ...
        : state.active.state;
      state.active.lga = action.payload.lga
        ? action.payload.lga
        : state.active.lga;
      state.active.zone = action.payload.zone
        ? action.payload.zone
        : state.active.zone;
      state.activeBounds = action.payload.bound
    ...
    fullReset: (state) => {
      ...
      state.activeBounds = [9.67475603288972, 7.287066434953559];
    },
  },
});
